...
# https://www.perplexity.ai/search/how-do-you-Om2Tqd5BRNW7fojIJpVh8Q?s=c
...
1.  Look at the plot that you created. What do you notice about the order of the bars / order of the legend? They are not in sequential order wrt the sanitation ladder
2.  What would you want to change? start with no sanitation, then unimproved, then limited, then basic
3.  Why did we remove "safely managed sanitation services" from the data set in Task 3? safely manged sanitation services and basic sanitation services are not mutually exclusive, so the total would have exceeded 100%

## Task 7

1.  Run the code in the code chunk below.

2.  What do you observe when you look at the code and plot? The facets are by residence (national, rural and urban) and the sanitation levels (basic, limited, open defecation, safely managed, unimproved), with the number of countries at a given percentage on the y-axis and the percent on the x-axis.

    Overall, there are far fewer countries reporting safely managed sanitaiton (maximum of 10 at any given percentage). A large number of countries report being ODF, with a similar but slightly lower number reporting 0% of the population relying on unimproved sanitation.
